...
- point of confusion: D are in units of L^2/T (km^2/day), yet nothing in the cpp code is ever actually distance-aware? so how can it possibly be factored in? (it must be because of the units of pop densities)
